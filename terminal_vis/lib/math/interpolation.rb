...
# @Last Modified time: 2015-08-19 12:24:38

require_relative '../data/meta_data'
require 'matrix'

# math class to interpolate data between a set of points. Raises {RangeError}
# when the provided coordinates do not lie within the data area of the meta data
class Interpolation
    ...
    # of the dataset
    # @param [DataDomain] data_domain domain of the meta_data corresponding to
    #   the coordinate
    # @param [DataPoint] coordinate component of the coordinate to check
